...
!function (t, e) {
    ...
    var Bt = it.extend({
        ...
        update: function (t) {
            ...
            if (m < zt) {
                var b = l.rotation % zt, x = (b += b >= Rt ? -zt : b < -Rt ? zt : 0) + m, y = Math.cos(b),
                    _ = Math.sin(b), k = Math.cos(x), w = Math.sin(x), M = b <= 0 && x >= 0 || x >= zt,
                    S = b <= Nt && x >= Nt || x >= zt + Nt, C = b <= -Nt && x >= -Nt || x >= Rt + Nt,
                    ...
                    var i = t.options.layout || {}, a = H.options.toPadding(i.padding), r = e - a.width, o = n - a.height,
                        s = function (t) {
                            var e = function (t) {
                                    ...
                                    return a
                                }(t), n = le(se(e, "left"), !0), i = le(se(e, "right")), a = le(se(e, "top"), !0),
                                r = le(se(e, "bottom"));
                            return {
    ...
    var qe = K.extend({
        initialize: function () {
            ...
            var e, n, i, a, r, o, s, l, u, d, h = this, c = h._options, f = h._model, g = h._model = Ve(c),
    ...
    var xn = K.extend({
        zeroLineIndex: 0, getPadding: function () {
            ...
            var e, n, i, a, r, o, s, l, u, d, h, c, f, g, p, m, v, b = this, x = b.chart, y = b.options,
                ...
                C = S.length + (w ? 1 : 0), P = fn(_), A = [], D = _.drawBorder ? dn(_.lineWidth, 0, 0) : 0, T = D / 2,
                I = H._alignPixel, F = function (t) {
                    return I(x, t, D)
                };
            ...
            if (n.display) {
                var i, a, r, o, s, l = e.ctx, u = e.chart, d = H._alignPixel,
        ...
        getRightValue: function (t) {
            ...
            var t = this, e = t.options.ticks, n = t.getTickLimit(), i = {
                ...
                var n, i, a, r, o = [], s = t.stepSize, l = s || 1, u = t.maxTicks - 1, d = t.min, h = t.max,
                    c = t.precision, f = e.min, g = e.max, p = H.niceNum((g - f) / u / l) * l;
    ...
    var Xn = Cn.extend({
        setDimensions: function () {
            ...
            if (n.display) {
                var i, a, r = t.getIndexAngle(0), o = H.options._parseFont(n),
    ...
    var hi = yn.extend({
        initialize: function () {
            ...
            var t, e, n, i, a, r, o, s = this, l = s.chart, u = s._adapter, d = s.options, h = d.time.unit || "day",
                c = ti, f = Qn, g = [], p = [], m = [], v = s._getLabels();
    ...
    var Ai = K.extend({
        initialize: function (t) {
            ...
            var t = this, e = t.options, n = e.labels, i = e.display, a = t.ctx, r = H.options._parseFont(n),
            ...
            var t = this, e = t.options, n = e.labels, i = N.global, a = i.defaultColor, r = i.elements.line,
    ...
    var Fi = K.extend({
        ...
        draw: function () {
            ...
            if (n.display) {
                var i, a, r, o = H.options._parseFont(n), s = o.lineHeight, l = s / 2 + n.padding, u = 0, d = t.top,
    ...
    for (var Bi in Li.filler = Ri, Li.legend = zi, Li.title = Ni, en.helpers = H, function () {
        ...
        function n(n, i, a) {
            var r = document.defaultView, o = H._getParentNode(n), s = r.getComputedStyle(n)[i],
